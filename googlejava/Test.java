...
// out of alphebetical order (3.3.3)

// no newlines between nonstatic imports (3.3.3)
...
public class Test { // should have a javadoc (7.3)
  ...
  public int
      doOtherThings() { // there should be a newline before this method (4.6.1) and a javadoc (7.3)
    ...
    } // no concise empty parts of multiblock statements (4.1.3)
    System.out.println("Only one statement per line");
    System.out.println("(4.3)");
    System.out.println(
        "this line is longer than 100 characters 012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789"); // (4.4)
    System.out.println("Should break before the symbol"); // (4.5.1)
    System.out.println("Should be indented by 4 spaces"); // (4.5.2)
